...
public class Contexts {
    ...
    public static void copyToClipboard(Context paramContext, String paramString) {
        ((ClipboardManager) paramContext.getSystemService(Context.CLIPBOARD_SERVICE))
                .setText(paramString.trim());
    }
    ...
    public static CharSequence getClipboardString(ClipboardManager clipboardManager) {
